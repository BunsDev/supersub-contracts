...
async function main() {
  ...
  console.log(await subscription.getSubscriptionPlanById(1));
...
async function charge() {
  ...
  await subscription.charge(1, smartAccountAddress);
